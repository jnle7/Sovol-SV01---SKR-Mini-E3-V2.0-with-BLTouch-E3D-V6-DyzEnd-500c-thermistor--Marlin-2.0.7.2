...
#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 5  // add for DyzEnd 500c thermistor
...
#define MILLISECONDS_PREHEAT_TIME 30000  // add for DyzEnd 500c thermistor
